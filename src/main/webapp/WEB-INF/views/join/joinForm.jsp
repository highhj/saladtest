    ...
    <fieldset> 
        ...
        <table id="member_wrap"> 
            <tbody> 
                <tr> 
                    <td class="lb">* 이메일</td> 
                    <td><input type="text" id="m_email" name="m_email" style="width: 130px;" value=""/></td>
                    <td></td> 
                </tr> 
                <tr> 
                    <td class="lb">* 비밀번호</td> 
                    <td><input type="password" id="m_pwd" name="m_pwd" style="width: 130px;" value=""/></td>
                    <td></td> 
                </tr> 
                 <tr> 
                    <td class="lb">* 이름</td> 
                    <td><input type="text" id="m_name" name="m_name" style="width: 130px;" value=""/></td>
                    <td></td> 
                </tr> 
